...
if __name__ == "__main__":
    ...
    try:
        ...
        for filename in os.listdir(directory_path):
            ...
            output_filepath = os.path.join("./question_papers_insights"+"/", filename+".txt")
                    ...
                    with open(file_path, 'r') as file:
                        ...
                        response = ai_client.chat.completions.create(
                            ...
                            messages=[
                                ...
                                {"role": "user", "content": "You have been provided with a csv file which has the questions given in an examination over a period of many years. It has columns - year,month,section,question,topic. You as an intelligent assistant, identify patterns and useful insights so that student can prepare for the exam. The questions csv content starts from here - "+content},
                            ],
                            temperature=0,
                        )
